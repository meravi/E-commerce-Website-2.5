  		...
  		<div class="col-md-3 col-sm-6">
    		<span class="thumbnail">
      			...
      			<div class="row">
      				...
      				<div class="col-md-6 col-sm-6">
      				 <a href="Home.php?NepdevPage=SingleProductDelete&id=<?php echo $NepdevDisProduct['id']; ?>">	<button class="btn btn-info right" > Delete</button></a>
      				</div>
